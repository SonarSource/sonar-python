...
class FileHashingUtilsTest {
  ...
  void hashing() throws IOException, NoSuchAlgorithmException {
    InputFile file1 = createInputFile(baseDir, "main.py", InputFile.Status.CHANGED, InputFile.Type.MAIN).wrappedFile();
    InputFile file2 = createInputFile(baseDir, "mod.py", InputFile.Status.SAME, InputFile.Type.MAIN).wrappedFile();
