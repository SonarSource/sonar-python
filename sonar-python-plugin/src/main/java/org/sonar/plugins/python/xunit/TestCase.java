...
public class TestCase {
   ...
   * @param stack The stack trace occurred while executing of this testcase;
   *               pass "" if the testcase passed/skipped.
   * @param msg The error message associated with this testcase of the execution
   *             was erroneous; pass "" if not.
   */
