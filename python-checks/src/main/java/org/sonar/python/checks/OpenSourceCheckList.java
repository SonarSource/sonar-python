...
import org.sonar.python.checks.tests.MisspelledMockAssertionCheck;
...
public class OpenSourceCheckList {
  ...
  public Stream<Class<?>> getChecks() {
    return Stream.of(
      ...
      BadReversedSequenceCheck.class,
      ...
      ListExtendOverIndividualAppendsCheck.class,
      ...
      MisspelledMockAssertionCheck.class,
      ...
      SetUpdateOverIndividualAddsCheck.class,
