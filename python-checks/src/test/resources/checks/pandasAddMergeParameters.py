...
def non_compliant_2():
    ...
    _ = join(age_df, name_df)  # Noncompliant {{The 'how', 'on' and 'validate' parameters of the join should be specified.}}

    _ = join(age_df, name_df, on="user_id")  # Noncompliant {{The 'how' and 'validate' parameters of the join should be specified.}}

    _ = join(age_df, name_df, how="right")  # Noncompliant {{The 'on' and 'validate' parameters of the join should be specified.}}

    _ = join(age_df, name_df, validate="1:1")  # Noncompliant {{The 'how' and 'on' parameters of the join should be specified.}}

    _ = join(age_df, name_df, how="right", on="user_id")  # Noncompliant {{The 'validate' parameter of the join should be specified.}}

    _ = join(age_df, name_df, on="user_id", validate="1:1")  # Noncompliant {{The 'how' parameter of the join should be specified.}}

    _ = join(age_df, name_df, how="cross", validate="1:1")  # Noncompliant {{The 'on' parameter of the join should be specified.}}
