...
iam.PolicyStatement(
    ...
    resources=["*"] # Noncompliant {{This policy is vulnerable to the "Create Policy Version" privilege escalation vector. Remove permissions or restrict the set of resources they apply to.}}
)
