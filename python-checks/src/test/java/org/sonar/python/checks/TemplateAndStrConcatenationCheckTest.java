...
class TemplateAndStrConcatenationCheckTest {
  ...
  void test() {
    ...
    PythonCheckVerifier.verify("src/test/resources/checks/templateAndStrConcatenation.py", new TemplateAndStrConcatenationCheck());
  }
  ...
  void test_older_python_version() {
    ...
    var issues = PythonCheckVerifier.issues("src/test/resources/checks/templateAndStrConcatenation.py", new TemplateAndStrConcatenationCheck());
