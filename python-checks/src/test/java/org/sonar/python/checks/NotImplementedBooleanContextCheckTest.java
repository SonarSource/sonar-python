...
class NotImplementedBooleanContextCheckTest {
  ...
  void test() {
    ...
    PythonCheckVerifier.verify("src/test/resources/checks/notImplementedBooleanContextCheck.py", new NotImplementedBooleanContextCheck());
  }
  ...
  void test_older_python_version() {
    ...
    var issues = PythonCheckVerifier.issues("src/test/resources/checks/notImplementedBooleanContextCheck.py", new NotImplementedBooleanContextCheck());
