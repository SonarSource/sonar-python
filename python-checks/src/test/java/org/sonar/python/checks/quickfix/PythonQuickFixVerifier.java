...
public class PythonQuickFixVerifier {
  ...
  public static void verify(Function<String, PythonVisitorContext> createVisitorContext, PythonCheck check, String codeWithIssue, String... codesFixed) {
    ...
    assertThatCode(() -> PythonParser.createIPythonParser().parse(String.join("\n", codesFixed))).as("Correction of quick fixes")
      .overridingErrorMessage("The code generated by the quickfix is not valid (I)Python code.\nResults is :\n%s", Arrays.asList(codesFixed))
      .doesNotThrowAnyException(); // We assume that any IPython code is valid Python code
