...
class PythonQuickFixVerifierTest {
  ...
  void test_verify_invalid_after() {
    var expectedMsg = "[Correction of quick fixes] The code generated by the quickfix is not valid (I)Python code.\n" +
      "Results is :\n" +
      "[a!!=10]";
    var check = new SimpleCheckInvalidSyntax();
  ...
  private class SimpleCheckInvalidSyntax extends PythonSubscriptionCheck {
    @Override
    public void initialize(Context context) {
      context.registerSyntaxNodeConsumer(Tree.Kind.ASSIGNMENT_STMT, ctx -> {
        AssignmentStatement assignment = ((AssignmentStatement) ctx.syntaxNode());
