...
public class NotebooksTest {

  public static final String PROJECT_KEY = "project2";
  ...
  static void prepare_quality_profile() {
    ...
    File pythonProfileFile = ProfileGenerator.generateProfile(serverUrl, "ipynb", "ipython", parameters, Collections.emptySet());
    ORCHESTRATOR.getServer().restoreProfile(FileLocation.of(pythonProfileFile));
    File IPythonProfileFile = ProfileGenerator.generateProfile(serverUrl, "py", "python", parameters, Collections.emptySet());
  ...
  void test() throws Exception {
    ...
    SonarScanner build = SonarScanner.create(FileLocation.of("../ipynb_json_project").getFile())
      .setProjectKey(PROJECT_KEY)
      .setProjectName(PROJECT_KEY)
      .setScannerVersion("4.3.0.2102")
      .setProjectVersion("1")
      .setSourceEncoding("UTF-8")
      .setSourceDirs(".")
      .setProperty("sonar.lits.dump.old", FileLocation.of("src/test/resources/expected2").getFile().getAbsolutePath())
