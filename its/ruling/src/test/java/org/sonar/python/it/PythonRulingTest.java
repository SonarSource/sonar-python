...
class PythonRulingTest {
  ...
  static void prepare_quality_profile() {
    ...
    File otherProfileFile = ProfileGenerator.generateProfile(serverUrl, "ipynb", "ipython", parameters, Collections.emptySet());
    ORCHESTRATOR.getServer().restoreProfile(FileLocation.of(otherProfileFile));
  }
