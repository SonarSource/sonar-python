...
echo ""
echo "##########################################################"
echo "### Generating PyType information for python-frontend tests ###"
echo "##########################################################"
echo ""
dir=python-frontend/src/test/resources/v2/code
python tools/extract-pytype-annotations/extract_info.py $dir python-frontend/src/test/resources/v2/code.json
