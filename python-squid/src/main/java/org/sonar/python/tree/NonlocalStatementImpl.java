...
public class NonlocalStatementImpl extends PyTree implements NonlocalStatement {
  ...
  public List<Tree> children() {
    return Stream.of(Collections.singletonList(nonlocalKeyword), variables, Collections.singletonList(separator)).flatMap(List::stream).filter(Objects::nonNull).collect(Collectors.toList());
  }
}
