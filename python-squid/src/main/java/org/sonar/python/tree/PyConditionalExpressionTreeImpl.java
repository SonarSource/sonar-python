...
public class PyConditionalExpressionTreeImpl extends PyTree implements PyConditionalExpressionTree {
  ...
  public PyConditionalExpressionTreeImpl(AstNode node, PyExpressionTree trueExpression, Token ifToken,
                                         PyExpressionTree condition, Token elseToken, PyExpressionTree falseExpression) {
    super(node);
