...
public class TypeShedTest {
  ...
  public void stdlib_symbols() {
    Map<String, Symbol> mathSymbols = TypeShed.typeShedSymbols("math").stream().collect(Collectors.toMap(Symbol::name, Function.identity()));
    ...
    Map<String, Symbol> threadingSymbols = TypeShed.typeShedSymbols("threading").stream().collect(Collectors.toMap(Symbol::name, Function.identity()));
    ...
    Map<String, Symbol> imaplibSymbols = TypeShed.typeShedSymbols("imaplib").stream().collect(Collectors.toMap(Symbol::name, Function.identity()));
  ...
  public void third_party_symbols() {
    Map<String, Symbol> emojiSymbols = TypeShed.typeShedSymbols("emoji").stream().collect(Collectors.toMap(Symbol::name, Function.identity()));
