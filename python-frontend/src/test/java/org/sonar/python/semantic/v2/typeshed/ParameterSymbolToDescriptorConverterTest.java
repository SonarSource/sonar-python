...
class ParameterSymbolToDescriptorConverterTest {
  ...
  void test() {
    ...
    Assertions.assertThat(pd2.annotatedType()).isEqualTo("builtins.int");
    ...
    Assertions.assertThat(pd3.annotatedType()).isEqualTo("builtins.str");
    ...
    Assertions.assertThat(pd4.annotatedType()).isEqualTo("builtins.int");
    ...
    Assertions.assertThat(pd5.annotatedType()).isEqualTo("builtins.int");
