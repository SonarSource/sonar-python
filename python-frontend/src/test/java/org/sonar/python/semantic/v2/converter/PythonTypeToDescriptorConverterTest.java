...
class PythonTypeToDescriptorConverterTest {
  ...
  void testConvertFunctionTypeWithoutDecorator() {
    ...
    FunctionType functionType = new FunctionType("functionType", List.of(new ModuleType("bar")), List.of(parameterV2), floatTypeWrapper, TypeOrigin.LOCAL, true, false, true, false, null, location);
  ...
  void testConvertManyTypes() {
    ClassType classType = new ClassType("classType", Set.of(new Member("aMember", intTypeWrapper.type())), List.of(), List.of(floatTypeWrapper), List.of(intTypeWrapper.type()), true, location);
    FunctionType functionType = new FunctionType("functionType", List.of(new ModuleType("bar")), List.of(), floatTypeWrapper, TypeOrigin.LOCAL, true, false, true, false, null, location);
